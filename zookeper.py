...
animals: List[str] = [camel, lion, deer, goose, bat, rabbit]

# write your code here
print("""Hello, zookeeper. Type the camera number you want to check,
from 0 to 5. Type 'exit' to finish the program""")
camera = ""
while True:
    camera = input()
    if camera == "exit":
